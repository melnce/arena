...
fn apply_attack(
    ...
    // Keep `attacking_follower` through Strike (Giada `10843110` `op: if`)
    // and AfterCombat. Verdilia crest already evaluated it on
    // AllyFollowerAttacks. Cleared with `combat_opposing` after damage.
