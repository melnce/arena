...
| `grantTraits` / `removeTraits` | `10724110` Rush; `10624110` Bane; `until: endOfOpponentTurn` `10721310` Measured Attunement / `10821120` Shaili "until the end of your opponent's turn" |
