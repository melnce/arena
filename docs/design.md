...
| Fuse: once per turn per instance, legal at 0 PP, partners banished, was-fused flag per-instance, α remembers kinds across turns; Gears fuse with Artifact amulets, Striker/Fortifier with Artifact cards | `rules/owner-rulings.md` Fuse mechanics; Fused cards are banished; Artifact fuse chain — 2026-09-05 (gears-only **Superseded 2026-09-10**); Artifact fuse partners follow the printed text — 2026-09-10; official Q&A `90073110` |
...
7. **Gears' fuse partners (`90071210` / `90071220`)** — answered 2026-09-10 (Chris, verbatim): _"Gears can fuse with any artifact amulet, Fortifier and striker can fuse with artifact cards in general."_ This supersedes the gears-only sentence of 2026-09-05. The printed text was right; authored `{tribe: artifact, kind: amulet}` on the Gears and `{tribe: artifact}` on Striker/Fortifier. The gear fused into still decides the body.
