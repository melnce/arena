...
| `on: static` `modifier.suppress` | **fixed** | Crest / field statics suppress the listed `TriggerTag`s on matching instances, including play-time Fanfare / Enhance (Milteo & Luzen `crest:10554110`, Mino Q&A). |
