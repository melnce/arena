...
**Artifact Portal** (`afnm-minatodao-mirror`): emitter `4552f1b0a6dc7f9b2b42d71c60389b088349de95` — `main` at or after `c923611b` (PR #390 merged; includes PR #391's live-slot `random_target`). Deck `oracle/decks/afnm-minatodao.json` (40 cards, no Sandalphon). 30 games, seed `20260910`, all `phase: "terminal"`.
...
git checkout 4552f1b0a6dc7f9b2b42d71c60389b088349de95
npm run trace -- --seed=20260910 --games=30 --deck-a=<arena>/oracle/decks/afnm-minatodao.json --deck-b=<arena>/oracle/decks/afnm-minatodao.json --out=<tmp>/afnm-minatodao-mirror
```
...
The committed M1 sets at `c9c7aad2`, the Abyss set at `2dfd184c`, and the Artifact Portal set at `4552f1b` pass all four checks: every game's last line is `phase: "terminal"`.
