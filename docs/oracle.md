...
**Rune / Elf** (`rune-mach15-mirror`, `elf-neanisu2-mirror`): emitter `4552f1b` on Practice-Tool `main` (PR #390 merged at `c923611b`; this SHA also includes PR #391). Recorded 2026-09-10, 30 games each, seed `20260910`.
...
git checkout main   # at c923611b or newer
...
The committed M1 sets at `c9c7aad2` and the Abyss set at `2dfd184c` pass all four checks: every game's last line is `phase: "terminal"`.
